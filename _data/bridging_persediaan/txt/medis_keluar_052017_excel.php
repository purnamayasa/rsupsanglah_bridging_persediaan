	...
	SELECT
		...
		(
			...
			FROM
				simrs2012.2017_penerimaan
			WHERE
				tgljam BETWEEN '2017-05-01 00:00:00'
...
header("content-disposition: attachment;filename=medis_keluar_052017.xls");
?>
