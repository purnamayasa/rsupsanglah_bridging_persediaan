...
require_once 'gizi_txt.php';
require_once 'medis_txt.php';
require_once 'non_medis_txt.php';
...
header("content-disposition: attachment;filename=transaksi_{$tglAwalx}__{$tglAkhirx}.txt");	
