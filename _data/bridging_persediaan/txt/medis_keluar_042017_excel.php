	...
	SELECT
		...
		(
			...
			FROM
				simrs2012.2017_penerimaan
			WHERE
				tgljam BETWEEN '2017-04-01 00:00:00'
			AND '2017-04-30 23:59:59'
			AND kode_barang = S.id
		) AS masuk,
		'' AS keluar,
		(
...
header("content-disposition: attachment;filename=medis_keluar_042017.xls");
?>
