	...
	SELECT
		...
		(
			...
			FROM
				simrs2012.2017_stokopname
			WHERE
				tgljam = '2017-07-31 23:59:59'
			AND kode_barang = S.id
			AND keterangan LIKE '%STOK OPNAME 2017 JULI%'
			AND posting = 1
			LIMIT 1
		) AS harga,
		(
		...
		(
			...
			WHERE
				PG.TGL_TERIMA BETWEEN '2017-07-01 00:00:00'
			AND '2017-07-31 23:59:59'
...
header("content-disposition: attachment;filename=medis_keluar_072017.xls");
?>
