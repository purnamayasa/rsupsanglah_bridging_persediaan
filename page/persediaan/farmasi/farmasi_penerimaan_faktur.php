...
$tabel = 'farmasi_penerimaan_faktur_excel';
?>
<h3>Import Excel Farmasi Penerimaan Faktur</h3>
...
<?php
if (isset($_POST['submit']) && $_POST['submit'] == 'Import' && !empty($tahun) && !empty($bulan) && !empty($_FILES['filefarmasi']['name'])) {
	$start = false;
